...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_331__) {
...
var _jsWalletconnectCore = __webpack_require__(330);
...
var WalletConnect = function (_Connector) {
  ...
  function WalletConnect() {
    ...
    return _possibleConstructorReturn(this, (WalletConnect.__proto__ || Object.getPrototypeOf(WalletConnect)).apply(this, arguments));
  }
  ...
  _createClass(WalletConnect, [{
    ...
    value: function listenSessionStatus(cb) {
      ...
      return new _jsWalletconnectCore.Listener(this, {
        fn: function fn() {
          return _this2.getSessionStatus();
        },
        cb: cb,
    ...
    value: function listenTransactionStatus(transactionId, cb) {
      ...
      return new _jsWalletconnectCore.Listener(this, {
        fn: function fn() {
          return _this3.getTransactionStatus(transactionId);
        },
        cb: cb,
        pollInterval: pollInterval,
        timeout: timeout
