...
var WalletConnect = function (_Connector) {
  ...
  function WalletConnect(canvasElement, bridgeURL) {
    _classCallCheck(this, WalletConnect);

    var _this = _possibleConstructorReturn(this, (WalletConnect.__proto__ || Object.getPrototypeOf(WalletConnect)).call(this));

    _this.canvasElement = typeof canvasElement !== 'undefined' ? canvasElement : 'walletconnect-qr-code';
    _this.bridgeURL = bridgeURL;
    return _this;
  }
  //
  // Create session
  ...
  _createClass(WalletConnect, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                (0, _jsWalletconnectCore.handleResponse)(res);
              ...
              case 12:
                ...
                _context.next = 17;
                return _qrcode2.default.toDataURL(this.canvasElement, sessionData, {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                throw new Error('Create session using `createSession` before sending transaction');
    ...
    value: function getTransactionStatus(transactionId) {
      ...
      return this._getEncryptedData('/session/' + this.sessionId + '/transaction/' + transactionId + '/status');
    }
    ...
    value: function listenSessionStatus(cb) {
      ...
      return new _jsWalletconnectCore.Listener(this, {
        fn: function fn() {
          return _this3.getSessionStatus();
        },
        cb: cb,
    ...
    value: function listenTransactionStatus(transactionId, cb) {
      ...
      return new _jsWalletconnectCore.Listener(this, {
        fn: function fn() {
          return _this4.getTransactionStatus(transactionId);
        },
        cb: cb,
        pollInterval: pollInterval,
        timeout: timeout
...
var CanvasRenderer = __webpack_require__(360)
var SvgRenderer = __webpack_require__(361)
...
var Version = __webpack_require__(131)
var FormatInfo = __webpack_require__(353)
var Mode = __webpack_require__(43)
var Segments = __webpack_require__(354)
var isArray = __webpack_require__(94)
...
var Mode = __webpack_require__(43)
var NumericData = __webpack_require__(355)
var AlphanumericData = __webpack_require__(356)
var ByteData = __webpack_require__(357)
var KanjiData = __webpack_require__(358)
var Regex = __webpack_require__(132)
var Utils = __webpack_require__(42)
